...
const NetworthPage = () => {
    ...
    async function calculateNetworth() {
        ...
        if (!unitsJson.data.code == 1) {
            ...
            setNetworth("Something went Wrong! You may have used an invalid API key or the Final Earth API failed.")
        }
    }
    ...
    return (
        ...
        <div className="post-content-body">
            ...
            Enter your FE api key to see your total networth (units value + cash on hand + reimbursement value).
            
            After clicking
            submit it may take a couple of seconds for the request to complete and show your networth. 
            </p>
